...
const Hero = () => {
  ...
  return (
    ...
    >
      {/* Background decoration: subtle technical grid lines */}
      ...
      <div className="max-w-5xl mx-auto px-6 sm:px-10 lg:px-16 w-full relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 items-center">
          ...
          <div className="md:col-span-8 flex flex-col gap-8">
            ...
            {/* Monospace High-Impact Metric Block */}
            ...
            {/* Radix buttons/tabs with slideable background spring highlight */}
            <div className="pt-4">
                  ...
                  return (
                    ...
                    >
                      {hoveredIdx === idx && (
                        <motion.div
                          layoutId="hover-bg"
                          className="absolute inset-0 bg-white dark:bg-zinc-800/80 shadow-[0_1px_3px_rgba(0,0,0,0.05),0_1px_1px_rgba(0,0,0,0.02)] border border-zinc-200/50 dark:border-zinc-700/50 z-0"
                          transition={{
                            type: "spring",
                            stiffness: 380,
                            damping: 30,
          ...
          <div className="hidden md:flex md:col-span-4 justify-end items-center">
            <div className="relative w-full max-w-[320px] h-[400px] lg:max-w-[350px] lg:h-[470px] overflow-hidden rounded-none border-2 border-zinc-200 dark:border-zinc-800 bg-zinc-100 dark:bg-zinc-900 shadow-2xl transition-all duration-500 ease-out hover:border-zinc-400 dark:hover:border-zinc-700 group">
              <img
                src={avatar}
                alt="Juathan Coelho Duarte"
                className="w-full h-full object-cover filter grayscale contrast-[1.05] hover:grayscale-0 transition-all duration-500 ease-out scale-100 hover:scale-[1.02]"
              />
            </div>
          </div>
