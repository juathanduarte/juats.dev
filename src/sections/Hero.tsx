        ...
        >
          ...
          <motion.div variants={imageVariants} className="flex-shrink-0">
            <img
              ...
              className="w-40 h-40 sm:w-48 sm:h-48 lg:w-56 lg:h-56 rounded-lg object-cover shadow-lg"
            />
          </motion.div>
            ...
            >
              {SOCIAL_LINKS.map((link, index) => (
                <motion.a
                  ...
                  className="text-gray-600 hover:text-primary-600 transition-colors text-2xl"
                  tabIndex={0}
